...
class Model_Finder:
    """This class used to find ML model with best score and auc roc score"""

    def __init__(self, file_object, logger_object):
        self.file_object = file_object
        self.logger_object = file_object
        self.gnb = GaussianNB()
    ...
    def get_best_params_for_naive_bayes(self, train_x, train_y):
        """
        get the parameter for the Naive Bayes's algorithm which give the best accuracy
        """
        self.logger_object.log(self.file_object, 'Entered the get_best_params_for_naive_bayes method of the Model_Finder class')
        try:
            # initializing woth different combination of parameters
    ...
    def get_best_params_for_xgboost(self, train_x, train_y):
        ...
        try:
            ...
            self.param_grid_xgboost = {
                "n_estimators" : [50, 100, 130], "max_depth": range(3, 11, 1), "random_state": [0, 50, 100]
            }

            # Crating an object of the Grid Search class
    ...
    def get_best_model(self, train_x, train_y, test_x, test_y):
        ...
        try:
            self.xgboost = self.get_best_params_for_xgboost(train_x, train_y, test_x, test_y)
