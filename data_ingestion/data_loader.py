...
class Data_Getter:
    ...
    def get_data(self):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,'Data_Load Successful.Exited the get_data method of the Data_Getter class')
            return self.data
            ...
            self.logger_object.log(self.file_object, 'Data Load Unsuccessful. Exited the get_data ethod of the Data_Getter class')
            raise Exception()
