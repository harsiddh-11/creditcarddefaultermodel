...
class train_validation:
    ...
    def train_validation(self):
        try:
            ...
            # validation filename of prediction files
            ...
            self.log_writer.log(self.file_object, "Creating Training_DataBase andtables on the basis of given schema!!!")
            # create database with given name, if present open the connections! Create table with columns given in schema
            self.dBOperation.createTableDb('Training', column_names)
            self.log_writer.log(self.file_object, "Table creation Comlpleted!!!")
